            ...
            {loading ? (
                ...
                <ul className="space-y-4">
                    {messageBoxes.map((box) => (
                        <li key={`${box.adId}_${box.chatId}`} className="p-4 border rounded shadow-sm flex items-center gap-4">
                            <Image
                                src={box.adPhoto}
                                alt={box.adTitle}
                                width={80}
                            ...
                            <div className="flex-1">
                                ...
                                <p>
                                    <strong>Kullanıcı:</strong> {box.otherUserName}
                                    <strong> (ID: <Link href={`/admin/message-boxes/${box.otherUserId}`}>{box.otherUserId}</Link>)</strong>
                                </p>
